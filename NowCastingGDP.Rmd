...
cor(ncastSP$`quarterly GDP (expend-based)`,ncastSP$`monthly GDP (basic prices)`)
ncastSP %>% na.omit(`quarterly GDP (expend-based)`)
...
AIC(ncast.1) #regression ANOVA table
aov(ncast.1) #Akaike’s criterion
fitted <- fitted(ncast.1) #fitted values
